...
using (var sw = new StreamWriter(Path.Combine(dir, "../Shipwreck.CSharpModels/Expressions/Generated Codes/ExpressionTypes.cs")))
{
    var types = new[]
    {
    ...
    sw.WriteLine("namespace Shipwreck.CSharpModels.Expressions");
    sw.WriteLine("{");
